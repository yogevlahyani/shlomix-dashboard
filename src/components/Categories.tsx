...
class Categories extends React.Component<StateTypes> {
  ...
  fetchCategories: any = (): void => {
    axios.get('http://104.236.92.123:8080/categories').then((cats) => {
      this.setState({
        cats: cats.data
      });
  ...
  openAddCategory: any = (): void => {
    swal({
      ...
      if(e != null && e != '') {
        axios.post('http://104.236.92.123:8080/categories/addCategory', {
          name: e
        })
        .then((res: any): void => {
          console.log(res);
  ...
  openChangeIcon: any = (cat: any): void => {
    swal({
      ...
      if(e != null && e != '') {
        axios.post('http://104.236.92.123:8080/categories/updateCategory', {
          id: cat._id,
          iconURL: e
        }).then((res: any): void => {
          console.log(res);
  ...
  _delCategory = (cat: any): void => {
    ...
    .then((willDelete) => {
      if (willDelete) {
        axios.post('http://104.236.92.123:8080/categories/deleteCategory', {
          id: cat._id
        }).then((res: any): void => {
          console.log(res);
          swal(res.data.feedback, {
